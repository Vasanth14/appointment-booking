        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              View available 30-minute appointment slots and book your
              appointment
            </p>
          </div>
          ...
          {slotsLoading ? (
            ...
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <Button
                  variant="outline"
                  onClick={() => dispatch(fetchAvailableSlots())}
                >
                  Refresh
                </Button>
              </CardContent>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      {slot.isBookedByUser ? (
                        ...
                        <Link
                          href={`/dashboard/book-appointment?slotId=${slot.id}`}
                        >
